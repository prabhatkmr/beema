# EKS Cluster Module - Production-Grade Kubernetes
#
# Features:
...
# - CloudWatch logging
# - Security group for control plane communication
...
resource "aws_eks_cluster" "main" {
  ...
  vpc_config {
    ...
    public_access_cidrs     = var.cluster_endpoint_public_access ? var.cluster_endpoint_access_cidrs : []
